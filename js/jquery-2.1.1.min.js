...
!function (a, b) {
    ...
    n.extend({clone: function (a, b, c) {
        ...
        for (var e, f, g, h, i, j, k = b.createDocumentFragment(), l = [], m = 0, o = a.length; o > m; m++)if (e = a[m], e || 0 === e)if ("object" === n.type(e))n.merge(l, e.nodeType ? [e] : e); else if (cb.test(e)) {
            f = f || k.appendChild(b.createElement("div")), g = (bb.exec(e) || ["", ""])[1].toLowerCase(), h = ib[g] || ib._default, f.innerHTML = h[1] + e.replace(ab, "<$1>") + h[2], j = h[0];
    ...
    n.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: fc, type: "GET", isLocal: jc.test(ec[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": pc, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText", json: "responseJSON"}, converters: {"* text": String, "text html": !0, "text json": n.parseJSON, "text xml": n.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (a, b) {
        ...
        return a.offsetWidth <= 0="" &&="" a.offsetheight="" <="0" },="" n.expr.filters.visible="function" (a)="" {="" return!n.expr.filters.hidden(a)="" };="" var="" wc="/%20/g," xc="/\[\]$/," yc="/\r?\n/g," zc="/^(?:submit|button|image|reset|file)$/i," ac="/^(?:input|select|textarea|keygen)/i;" function="" bc(a,="" b,="" c,="" d)="" e;="" if="" (n.isarray(b))n.each(b,="" (b,="" e)="" c="" ||="" xc.test(a)="" ?="" d(a,="" :="" bc(a="" +="" "["="" ("object"="=" typeof="" e="" b="" "")="" "]",="" e,="" });="" else="" (c="" "object"="" !="=" n.type(b))d(a,="" b);="" for="" (e="" in="" b)bc(a="" b[e],="" }="" n.param="function" (a,="" b)="" d="[]," b()="" null="=" ""="" d[d.length]="encodeURIComponent(a)" "=" + encodeURIComponent(b)
        };
        if (void 0 === b && (b = n.ajaxSettings && n.ajaxSettings.traditional), n.isArray(a) || a.jquery && !n.isPlainObject(a))n.each(a, function () {
            e(this.name, this.value)
        }); else for (c in a)Bc(c, a[c], b, e);
        return d.join(" &").replace(wc,="" "+")="" n.fn.extend({serialize:="" ()="" return="" n.param(this.serializearray())="" serializearray:="" this.map(function="" a="n.prop(this," "elements");="" n.makearray(a)="" this="" }).filter(function="" this.name="" !n(this).is(":disabled")="" ac.test(this.nodename)="" !zc.test(a)="" (this.checked="" !t.test(a))="" }).map(function="" n.isarray(c)="" n.map(c,="" return{name:="" b.name,="" value:="" a.replace(yc,="" "\r\n")}="" })="" {name:="" c.replace(yc,="" }).get()="" }}),="" n.ajaxsettings.xhr="function" try="" new="" xmlhttprequest="" catch="" cc="0," dc="{}," ec="{0:" 200,="" 1223:="" 204},="" fc="n.ajaxSettings.xhr();" a.activexobject="" n(a).on("unload",="" (var="" dc)dc[a]()="" }),="" k.cors="!!Fc" "withcredentials"in="" fc,="" k.ajax="Fc" =="" !!fc,="" n.ajaxtransport(function="" b;="" !a.crossdomain="" {send:="" (c,="" f="a.xhr()," g="++Cc;" (f.open(a.type,="" a.url,="" a.async,="" a.username,="" a.password),="" a.xhrfields)for="" a.xhrfields)f[e]="a.xhrFields[e];" a.mimetype="" f.overridemimetype="" f.overridemimetype(a.mimetype),="" a.crossdomain="" c["x-requested-with"]="" (c["x-requested-with"]="XMLHttpRequest" );="" c)f.setrequestheader(e,="" c[e]);="" (delete="" dc[g],="" f.onerror="null," "abort"="==" f.abort()="" "error"="==" d(f.status,="" f.statustext)="" d(ec[f.status]="" f.status,="" f.statustext,="" "string"="=" f.responsetext="" {text:="" f.responsetext}="" void="" 0,="" f.getallresponseheaders()))="" f.onload="b()," b("abort");="" f.send(a.hascontent="" a.data="" null)="" (h)="" (b)throw="" h="" abort:="" }}="" n.ajaxsetup({accepts:="" {script:="" "text="" javascript,="" application="" ecmascript,="" x-ecmascript"},="" contents:="" (?:java|ecma)script="" converters:="" {"text="" script":="" n.globaleval(a),="" }}}),="" n.ajaxprefilter("script",="" a.cache="" (a.cache="!1)," (a.type="GET" )="" n.ajaxtransport("script",="" (a.crossdomain)="" c;="" return{send:="" (d,="">").prop({async: !0, charset: a.scriptCharset, src: a.url}).on("load error", c = function (a) {
